...
static void w2c_add_run_0(w2c_add*);

FUNC_TYPE_T(w2c_add_t0) = "\x89\x3a\x3d\x2c\x8f\x4d\x7f\x6d\x6c\x9d\x62\x67\x29\xaf\x3d\x44\x39\x8e\xc3\xf3\xe8\x51\xc1\x99\xb9\xdd\x9f\xd5\x3d\x1f\xd3\xe4";
FUNC_TYPE_T(w2c_add_t1) = "\x36\xa9\xe7\xf1\xc9\x5b\x82\xff\xb9\x97\x43\xe0\xc5\xc4\xce\x95\xd8\x3c\x9a\x43\x0a\xac\x59\xf8\x4e\xf3\xcb\xfa\xb6\x14\x50\x68";

/* export: 'run' */
void w2c_add_run(w2c_add* instance) {
  w2c_add_run_0(instance);
}

static void init_instance_import(w2c_add* instance, struct w2c_env* w2c_env_instance) {
  instance->w2c_env_instance = w2c_env_instance;
}

void wasm2c_add_instantiate(w2c_add* instance, struct w2c_env* w2c_env_instance) {
  assert(wasm_rt_is_initialized());
  init_instance_import(instance, w2c_env_instance);
}

void wasm2c_add_free(w2c_add* instance) {
}
...
void w2c_add_run_0(w2c_add* instance) {
  FUNC_PROLOGUE;
  u32 var_i0;
  var_i0 = 42u;
  w2c_env_log(instance->w2c_env_instance, var_i0);
  FUNC_EPILOGUE;
}
